...
onready var hideandseek=$HIDE_AND_SEEK_TALK/Label
onready var hideandseek2=$HIDE_AND_SEEK_TALK/Label2
onready var hideandseek3=$HIDE_AND_SEEK_TALK/Label3
...
func _process(_delta):
	...
	if hideandseek2.visible==false and hideandseek.visible==false and hideandseek3.percent_visible>=1 and Input.is_action_just_pressed("enter"):
		$HIDE_AND_SEEK_TALK.visible=false
